...
# Run seelcted tests under cuda's compute-sanitizer
...
TESTS_TO_RUN=("nvblox_benchmark --benchmark_filter=benchmarkAll"
              ...
              "test_occupancy_integrator --gtest_filter=OccupancyIntegratorTest.ReconstructPlane"
              "test_occupancy_decay"
              "test_tsdf_integrator --gtest_filter=DeviceTests/TsdfIntegratorTestParameterized.ReconstructPlane/0"
              "test_tsdf_decay"
             )
